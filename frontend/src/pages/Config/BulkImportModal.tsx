      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
          ...
          <section>
            ...
            <p className="text-sm text-ink-600 mb-3">
              IDs are generated by the system. Existing rows are matched by
              their natural keys: Teams by <code>name</code>, Projects by{" "}
              <code>code</code>, Persons by{" "}
              <code>(employee_id, team)</code>, SubProjects by{" "}
              <code>(project_code, name)</code>. Rows are never deleted — set{" "}
              <code>active</code> to FALSE to retire. To rename a Team or
              Project, use the form in this page.
            </p>
            <input
              ref={fileRef}
              type="file"
